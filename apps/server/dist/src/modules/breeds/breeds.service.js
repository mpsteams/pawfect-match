...
let BreedsService = BreedsService_1 = class BreedsService {
    constructor(prismaService) {
        this.prismaService = prismaService;
        this.logger = new common_1.Logger(BreedsService_1.name);
    }
    async getAllBreeds() {
...
exports.BreedsService = BreedsService = BreedsService_1 = __decorate([
